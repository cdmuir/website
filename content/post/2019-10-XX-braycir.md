...
tags = ["phyteclub", "plant physiology", "rstats", "bayCi", "photosynthesis"]
summary = "A computational platform for plant ecophysiology"
+++

Improvements:

* Simultaneous estimation of correction curve and ACi response
* Uses time series analysis to account for nonindependence in residuals
* Confidence intervals from the posterior
* Use strong priors rather than fixing unknown parameters
* Improved user interface

# old stuff from previous post
